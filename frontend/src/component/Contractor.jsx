...
const ContractorsPage = () => {
      ...
      renderCell: (params) => (
        <>
          ...
          <IconButton
            color="error"
            aria-label="Delete"
            onClick={() => handleDeleteContactPersonDetails(params.row._id)}
          >
            <GridDeleteIcon />
          </IconButton>
  ...
  const handleDeleteContactPersonDetails = (contactPersonId) => {
    dispatch(deleteContractor(contactPersonId))
      .then(() => {
                    ...
                    <form onSubmit={handleSubmit}>
                      ...
                      >
                        <Box display={"flex"} flexDirection={"column"}>
                          <Box display={"flex"}>
                            <Button
                              onClick={() => setOpenorEditContactDetails(true)}
                              disabled={disable}
                              variant="outlined"
                              fontWeight="bold"
                              color="success"
